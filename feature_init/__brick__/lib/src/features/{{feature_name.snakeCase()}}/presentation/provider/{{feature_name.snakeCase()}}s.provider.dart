...
import 'package:{{project_name.snakeCase()}}/src/features/{{feature_name.snakeCase()}}/domain/usecase/watch_{{feature_name.snakeCase()}}s.usecase.dart';
...
part '{{feature_name.snakeCase()}}s.provider.g.dart';
...
Stream<List<{{feature_name.pascalCase()}}Dto>> {{feature_name.camelCase()}}s(Ref ref) {
  ...
  final result = Watch{{feature_name.pascalCase()}}sUsecase({{feature_name.camelCase()}}Repository)();
