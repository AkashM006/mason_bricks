...
class Watch{{feature_name.pascalCase()}}Usecase extends Usecase<Stream<{{feature_name.pascalCase()}}Entity>, int> {
  final {{feature_name.pascalCase()}}Repository _{{feature_name.camelCase()}}Repository;

  const Watch{{feature_name.pascalCase()}}Usecase(this._{{feature_name.camelCase()}}Repository);

  @override
  Stream<{{feature_name.pascalCase()}}Entity> call({required int params}) =>
      _{{feature_name.camelCase()}}Repository.watch{{feature_name.pascalCase()}}(params);
}
