...
class Add{{feature_name.pascalCase()}}Usecase
  ...
  const Add{{feature_name.pascalCase()}}Usecase(this._{{feature_name.camelCase()}}Repository);

  @override
  Future<DataState<void>> call({required {{feature_name.pascalCase()}}Entity params}) =>
      _{{feature_name.camelCase()}}Repository.add{{feature_name.pascalCase()}}(params);
}
